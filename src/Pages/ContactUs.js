                ...
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col l6 s12">
                            ...
                            <a  className="btn btn-small deep-purple white-text" target="_blank" href="https://calendly.com/edunomics-chitransh/30min">Schedule a meeting?</a>
                    ...
                    <div className="row">
                        ...
                        <div className="col l6 s12 ">
                            ...
                            <a className="btn btn-small deep-purple white-text" href="mailto:contact@edunomics.in" target="_blank">Send a Mail</a>
